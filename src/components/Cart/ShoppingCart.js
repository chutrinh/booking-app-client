...
function ShoppingCart() {
  ...
  useEffect(() => {
    axios
      .get("https://booking-app-agfh.onrender.com/cart/get-cart", {
        headers: {
  ...
  const hanldeChangeAmount = (e) => {
    setLoading(true);
    axios("https://booking-app-agfh.onrender.com/cart/update-cart", {
      headers: {
        "Content-Type": "application/json",
      },
      method: "POST",
  ...
  const handleDelet = (e) => {
    ...
    if (window.confirm("bạn có muốn xóa sản phẩm này?")) {
      ...
      axios("https://booking-app-agfh.onrender.com/cart/delete-product", {
        headers: {
          "Content-Type": "application/json",
        },
        method: "POST",
                    ...
                    return (
                      <tr key={item.product._id}>
                        <td>
                          <img
                            src={
                              "https://booking-app-agfh.onrender.com/" +
                              item.product.img1
                            }
                          />
                        </td>
